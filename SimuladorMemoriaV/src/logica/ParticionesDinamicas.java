...
public class ParticionesDinamicas {
    ...
    String[] nombreColumna = {"Proceso", "PID", "Tama�o", "Ocupado", "Inicio", "Fin"};
     ...
     */
    public boolean anadirProceso(Proceso proceso, int asignacion, boolean compactacion) {

        int posicion = 0;
        proceso.setPID(contadorPID);

        //Verificar que la memoria total disponible tenga el tama�o suficiente
        if(memTotalLibre >= proceso.getTamano()) {
            ...
            if(asignacion==1){
                ...
                if(posicion != 0) {
                    ...
                    if(particiones[posicion].getTamano() == proceso.getTamano()) {
                        ...
                        //Agrega la particion en la posicion donde hay espacio y le asigna el tama�o del proceso ("divide la particion")
                        ...
                        //la particion desplazada ("Sobrante que queda libre de la particion dividida") se le asigna nuevo tama�o he inicio.
            ...
            if (procesoAgregado == true) {
                ...
                if(compactacion == true & memTotalLibre >= proceso.getTamano()) {
                    ...
                    procesoAgregado = anadirProceso(proceso, asignacion, compactacion);
                    memTotalLibre = memTotalLibre - proceso.getTamano();
    ...
    public boolean compactar(int tamProceso) {
        ...
        while (tamParNueva < tamProceso) {
            ...
            //Asigna tama�o y posicion de inicio a la particion nueva y borra la segunda particion antigua
